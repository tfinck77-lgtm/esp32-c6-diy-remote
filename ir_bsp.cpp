...
// Lampe (NEC encodeNEC), TV (RC6) und Soundbar (sendRaw) werden NICHT
// gespiegelt.
// ---------------------------------------------------------------------
...
//
// Soundbar (Denon) laeuft NICHT mehr hierueber, sondern ueber
// ir_send_raw().
// ---------------------------------------------------------------------
                                ...
                                ir_protocol_t protocol)
{
  ...
  switch (protocol) {
    ...
    case IR_PROTO_DENON:
      // Nicht mehr verwendet - Denon laeuft ueber ir_send_raw().
      break;
  }
}
...
// ---------------------------------------------------------------------
// Rohdaten-Versand fuer Denon/Kaseikyo
//
// Die Original-Fernbedienung sendet den Kaseikyo-Denon-Befehl bei
// kurzem Tastendruck zweimal: erst den vollstaendigen Frame mit
// Adresse+Command, dann einen kurzen Gap und denselben Frame erneut.
// Manche Denon-Geraete (u.a. die Soundbar) verwerfen ein einzelnes
// Frame und warten auf die Wiederholung. Deshalb senden wir hier
// bewusst zwei Frames mit kurzem Abstand.
// ---------------------------------------------------------------------
