 ...
 * Size: 14 px
 * Bpp: 4
 * Opts: --font node_modules/@fontsource/montserrat/files/montserrat-latin-500-normal.woff --format lvgl --size 14 --bpp 4 --no-compress --range 0x20-0x7E --range 0xC4,0xD6,0xDC,0xDF,0xE4,0xF6,0xFC --lv-font-name font_de_14 -o /home/claude/font_de_14.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 3606, .adv_w = 188, .box_w = 12, .box_h = 13, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 3684, .adv_w = 177, .box_w = 9, .box_h = 13, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 3743, .adv_w = 151, .box_w = 8, .box_h = 11, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 3787, .adv_w = 134, .box_w = 8, .box_h = 11, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 3831, .adv_w = 142, .box_w = 9, .box_h = 11, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 3881, .adv_w = 152, .box_w = 8, .box_h = 11, .ofs_x = 1, .ofs_y = 0}
};
